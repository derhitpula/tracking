...
const CF_MARK = /Just a moment|cf-browser-verification|__cf_chl|cdn-cgi\/challenge-platform|Attention Required.{0,40}Cloudflare|Enable JavaScript and cookies to continue|Verifying you are human|_cf_chl_opt|cf-turnstile|Ray ID: [0-9a-f]{16}|class="cf-section cf-highlight"/i;
...
const BLOCK_PAGE = /<title>\s*Just a moment|Attention Required.{0,80}Cloudflare|Enable JavaScript and cookies to continue|Verifying you are human/is;
