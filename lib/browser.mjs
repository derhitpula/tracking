...
async function tryFetch(pw, useFirefox, sysFfPath, url) {
  ...
  try {
    ...
    // networkidle: warten bis keine Netzwerk-Anfragen mehr laufen (CF-JS lädt nach)
    await page.goto(url, { waitUntil: 'networkidle', timeout: 90000 }).catch(() => {});
    // Bis zu 90 s auf Challenge-Auflösung warten (CF Managed Challenge kann länger brauchen)
    for (let i = 0; i < 30; i++) {
