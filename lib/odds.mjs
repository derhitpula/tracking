...
async function theoddsapiOdds(home, away, date, code) {
  ...
  return events.length ? pickToddsOdds(events, home, away, code) : null;
}
...
// Fallback-Suche: The Odds API wenn API-Football keine Quote hat.
// Braucht home/away/date zusätzlich zum market code.
export async function referenceOddsFallback(home, away, date, code) {
  return theoddsapiOdds(home, away, date, code);
}
